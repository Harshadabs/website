...
$products = [
    ["title" => "60", "price" => "₹ 80", "image" => "photo scroll/Item_Genesis_Crystal.webp"],
    ["title" => "330", "price" => "₹ 390", "image" => "photo scroll/Item_Genesis_Crystal.webp"],
    ["title" => "1090", "price" => "₹ 1140", "image" => "photo scroll/Item_Genesis_Crystal.webp"],
    ["title" => "2240", "price" => "₹ 2450", "image" => "photo scroll/Item_Genesis_Crystal.webp"],
    ["title" => "3880", "price" => "₹ 3750", "image" => "photo scroll/Item_Genesis_Crystal.webp"],
    ["title" => "8080", "price" => "₹ 7500", "image" => "photo scroll/Item_Genesis_Crystal.webp"],
    ...
    <div class="container">
        <div class="section">
            ...
            <div class="input-row">
                ...
                <div class="sidebar">
                    <img src="photo scroll/Genshin_Impact.png" alt="Genshin Impact" width="200px" class="game-image">
